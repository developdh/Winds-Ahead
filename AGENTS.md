...
- Project identity: **Winds Ahead / 연운경 (燕雲鏡)**, an independent cosmetic reference for **Where Winds Meet / 연운**.
...
- 프로젝트명은 **Winds Ahead / 연운경(燕雲鏡)**이며, **Where Winds Meet / 연운** 외관 정보를 다루는 독립 팬 프로젝트입니다.
