...
**MVP:** 첫 접속 언어 선택, 이미지 갤러리, 검색, 브라우저 관심 저장, 반응형 출시 캘린더를 갖춘 영어·한국어 웹앱입니다. 주요 동선은 **외관**과 **캘린더** 두 가지입니다. 어두운 배경과 큰 이미지, 가벼운 Pretendard 본문을 사용하며 랜딩은 Noto Serif KR로 무협 정체성을 유지합니다.
