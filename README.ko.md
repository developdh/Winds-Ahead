...
- 외관 갤러리와 출시 정보를 화면의 중심에 둡니다.
- 중국 서버 사실, 글로벌 서버 사실, 운영자의 예상을 분리합니다.
- 출처, 날짜의 정밀도, 변경 이력을 보여주고 모르는 날짜는 미정으로 둡니다.
- 사이트와 프로젝트 문서를 영어·한국어로 제공하며, 식별과 검색을 위해 중국어 원명을 보존합니다.
...
게임 개발사·퍼블리셔와 무관한 비공식 팬 프로젝트입니다. 외부 게임 미디어와 상표의 권리는 각 권리자에게 있으며, 출처 표기만으로 재배포 권한이 생기지는 않습니다.
