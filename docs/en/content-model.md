...
When a new notice is discovered, review affected records and forecasts together. An internal 24–48 hour turnaround can be a working target, but no automatic monitoring or guaranteed service level exists yet. Record source, translation, and status corrections as revisions and include them in the next deployment.
