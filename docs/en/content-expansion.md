...
After the test, the original headset connection was restored. Replaying the isolated clip immediately reproduced `MEDIA SESSION PAUSE ACTION` and a pause at 0.000 seconds, completing the connected/disconnected/reconnected comparison. The headset remains connected. The manufacturer's [Beo Grace release notes](https://update.bang-olufsen.com/products/40e24b8c0b6d4742a13d2cf95671a60c) list a case-related Music App auto-pause correction in 1.2.6 and direct update checks to the B&O app. That is a relevant follow-up lead, not proof of this headset's firmware version or the precise accessory defect; no firmware update was performed.
